    ...
    $(".ts-count-down").each(function() {
        ...
        $(this).countdown({
            ...
            render: function(data) {
                var el = $(this.el);
                el.empty()
                    .append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.days, 2) + " </span><span class='ts-cc-description'>أيـام</span></div>")
                    .append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.hours, 2) + " </span><span class='ts-cc-description'>ساعــات</span></div>")
                    .append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.min, 2) + " </span><span class='ts-cc-description'>دقائــق</span></div>")
                    .append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.sec, 2) + " </span><span class='ts-cc-description'>ثوانــي</span></div>");
            }
        });
    });
